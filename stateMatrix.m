...
switch LeftPokeAction
    case 'rewarded_Lin'
        sma = AddState(sma, 'Name', 'Lin',...
            ...
            'StateChangeConditions', {LeftPortOut, 'Lin_grace','GlobalTimer1_End','pre_rewarded_Lin','Tup','pre_rewarded_Lin'},...
            'OutputActions', {});
        sma = AddState(sma, 'Name', 'pre_rewarded_Lin',...
            'Timer', TaskParameters.GUI.FeedbackDelay,...
            'StateChangeConditions', {LeftPortOut, 'rewarded_Lin'},...
            'OutputActions', {});        
    case 'unrewarded_Lin'
        sma = AddState(sma, 'Name', 'Lin',...
            'Timer', TaskParameters.GUI.FeedbackDelay,...
...
switch RightPokeAction
    case 'rewarded_Rin'
        sma = AddState(sma, 'Name', 'Rin',...
            'Timer', TaskParameters.GUI.FeedbackDelay,...
            'StateChangeConditions', {RightPortOut, 'Rin_grace','GlobalTimer1_End','pre_rewarded_Rin','Tup','pre_rewarded_Rin'},...
            'OutputActions', {});
        sma = AddState(sma, 'Name', 'pre_rewarded_Rin',...
            'Timer', TaskParameters.GUI.FeedbackDelay,...
            'StateChangeConditions', {RightPortOut, 'rewarded_Rin'},...
            'OutputActions', {});
    case 'unrewarded_Rin'
        sma = AddState(sma, 'Name', 'Rin',...
            'Timer', TaskParameters.GUI.FeedbackDelay,...
